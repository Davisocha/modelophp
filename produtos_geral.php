...
$row_produtos = $lista->fetch_assoc();//ele retorna apenas uma linha de uma matriz associativa
...
<?php if($num_linhas > 0){ ?>
    ...
    <div class="row">
        ...
        <?php }while($row_produtos = $lista->fetch_assoc());//sempre que se repetir ele trará uma linha associativa diferente  ?>
    </div>
