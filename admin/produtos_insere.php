...
//verifica se o btn "enviar" foi acionado
    ...
    $dir_img = "../images/".$rand.$nome_img;//ele gerará um valor aleatorio e ele recebera e concatenara com o nome

    //mover arquivo da pasta tmp para o dir de destino
    move_uploaded_file($tmp_img , $dir_img);//ele vai mover a imagem para o destino
}
//agora recuperaremos os valores dos inputs para inserirmos um produto
$id = $_POST['id_tipo'];
...
$insereProdutos = ("INSERT INTO produtos (tipo_id, descricao, resumo, valor, imagem, destaque) VALUES ($id,'$descricao','$resumo',$valor, '$imagem','$destaque')");

$inserir = $conn->query($insereProdutos);
...
//armazena o numero total de linhas dos registros na consulta
