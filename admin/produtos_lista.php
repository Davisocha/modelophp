    ...
    <main class="container">
        ...
        <table class="table table-hover table-condensed tb-opacidade bg-warning">
            ...
            <tbody> <!-- início corpo da tabela -->
                ...
                <!--iniciar o loop para alterar registros de produtos-->
                <?php do{?>
                <tr>
                    <td class="hidden">
                    <?php 
                    ...
                    <td>
                        ...
                        <?php 
                        //executa uma query de verificação de status de destaque
                        ...
                        <button
                            data-nome="<?php 
                            //define o atributo data-nome com a descricao do produto
                            echo $row['descricao'];
                            ?>"
                            data-id="<?php echo $row['id'];?>"
                            class="delete btn btn-xs btn-block btn-danger
                            <?php
                            //adiciona a classe hidden se o produto estiver em destaque para ocultar o botão de exlusão
