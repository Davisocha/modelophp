...
if($_POST){
    //se o usuario clicou no botão atualizar 
    if($_FILES['imagemfile']['name']){
    //se o usuario escolher uma imagem
    ...
    $id = $_POST['id'];
    $update = "UPDATE produtos set tipo_id=$id_tipo, destaque = '$destaque', descricao = '$descricao', resumo = '$resumo', valor = $valor, imagem = '$nome_img' where id =".$_POST['id'];
                        ...
                        <form action="produtos_atualiza.php" method="post"
                                ...
                                <select name="id_tipo" id="id_tipo" class="form-control" required>
                                    <?php do { ?>
                                        <option value="<?php echo $rowTipo['id']; ?>"
                                            <?php if (!(strcmp($rowTipo['id'], $row['tipo_id']))) echo "selected=\"selected\""; ?>>
                            ...
                            <div class="input-group">
                                ...
                                <textarea name="resumo" id="resumo"
                                    cols="30" rows="8"
                                    class="form-control" placeholder="Digite os detalhes do Produto"><?php echo $row['descricao'];?></textarea>
                            </div>
